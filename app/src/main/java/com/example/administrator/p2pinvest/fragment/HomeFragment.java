...
import com.example.administrator.p2pinvest.transform.AlphaTransform;
...
//        View view = View.inflate(getActivity(), R.layout.fragment_home, null);
        view = UiUtils.getView(R.layout.fragment_home);
...
//                List<Index.ImageArrBean> imageArrBeans = jsonObject.parseArray(imageArr, Index.ImageArrBean.class);
                ...
                Log.d(TAG, "onSuccess: " + index.getProInfo().getMoney());
                //更新数据
                ...
                //设置viewpager滑动效果
                view_pager.setPageTransformer(true, new AlphaTransform());
            }
            @Override
